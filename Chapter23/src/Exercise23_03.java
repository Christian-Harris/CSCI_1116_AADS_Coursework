...
*	Date: 9 October 2020. 
*	Description: This program implements two generic quick sort algorithms. One utilizes classes which implement the comparable interface while the other
*	utilizes a comparator object. In both instances the algorithm is recurisively implemented with a helper method called partition.
*/
