...
*	Date: 9 October 2020.
*	Description: This program has been modified to include a breadth first traversal and a height function.
*/
public class Exercise25_01 {
  ...
  public class BinaryTree<E extends Comparable<E>> extends AbstractTree<E> {
    ...
    public void breadthFirstTraversal() {
      ...
      java.util.ArrayList<TreeNode<E>> nodeList = new java.util.ArrayList<TreeNode<E>>();
	  if(root != null){
		  nodeList.add(root);
		  while(!nodeList.isEmpty()){
			 TreeNode<E> current = nodeList.remove(0);
			 queue.add(current);
